        ...
        <View style={styles.outerView}>
            ...
            <View style={styles.interface}>
                ...
                <View style={styles.group}>
                    ...
                    <TextInput placeholder="Enter your contact no." placeholderTextColor="#eca72c" style={styles.input}/>
                </View>
                ...
                <View style={styles.group}>
                    ...
                    <TextInput placeholder="Re-enter password" placeholderTextColor="#eca72c" style={styles.input}/>
                </View>
